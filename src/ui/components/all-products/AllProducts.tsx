...
import image7 from '/public/campaing/cam1.png';
      ...
      <div className="grid gap-2 sm:gap-6 grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 xl:grid-cols-5">
        {products.map((product) => (
          ...
          >
            ...
            <button
              className="mt-4 cursor-pointer items-center justify-center gap-2 border border-green-600 text-green-500 hover:text-white py-2 rounded-md hover:bg-green-700 transition-all hidden sm:flex"
            >
             View Details
            </button>
          </div>
