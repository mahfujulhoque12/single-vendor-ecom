...
const CategoryCard = () => {
  return (
    <div className="mt-5 bg-white  grid gap-2 grid-cols-2 sm:grid-cols-4 md:grid-cols-6 lg:grid-cols-8">
      {cardData.map((card) => (
        <div
          key={card.id}
          className="p-2 border border-gray-300 rounded-md shadow-sm group  transition-all duration-300"
        >
          <a href={card.href}>
